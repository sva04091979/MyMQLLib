...
#define TRADE_OPEN_PRICE_CHANGED 0x1000
#define TRADE_CHANGE_STOP     (TRADE_CHANGE_SL|TRADE_CHANGE_TP)
#define TRADE_CHANGED  (TRADE_CHANGE_STOP|TRADE_CHANGED_VOLUME|TRADE_OPEN_PRICE_CHANGED)
#define TRADE_SL_CHANGE_IN_PROCESS  0x2000
#define TRADE_TP_CHANGE_IN_PROCESS  0x4000
